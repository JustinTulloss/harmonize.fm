...
def make_map(global_conf={}, app_conf={}):
    ...
    #map.connect('wsgitrac/wiki/*path_info', controller='doku', action='dokupage', path_info='/')
    map.connect('wsgitrac/*path_info', controller='wsgitrac', action='tracpage', path_info='/')
