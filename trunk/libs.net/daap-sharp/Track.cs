...
namespace DAAP {
    ...
    {
        public Track(TrackBase copyTrack)
            :
            base(copyTrack)
        { }
        ...
        static internal ContentNode ToNode(TrackBase track, string[] fields)
        {
            ...
            ContentNode retVal = new ContentNode("dmap.listingitem", nodes);
            return retVal;
        }
        ...
        internal static ContentNode ToPlaylistNode(TrackBase track, int containerId)
        {
            return new ContentNode("dmap.listingitem",
                                    new ContentNode("dmap.itemkind", (byte)2),
                                    new ContentNode("daap.songdatakind", (byte)0),
                                    ...
                                    new ContentNode("dmap.containeritemid", containerId),
                                    new ContentNode("dmap.itemname", 
                                        track.Title == null ? String.Empty : track.Title));
        }
