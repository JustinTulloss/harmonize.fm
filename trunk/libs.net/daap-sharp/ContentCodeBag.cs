...
namespace DAAP {
    ...
    internal class ContentCodeBag {
        ...
        public static ContentCodeBag ParseCodes (byte[] buffer) {
            ...
            //XML-RPC specific codes
            // --Added for DMP - JMT::070201
            bag.AddCode("xmlm", "dmp.xmlrpcmessage", ContentType.String);
            bag.AddCode("xmlr", "dmp.xmlrpcresponse", ContentType.Container);
